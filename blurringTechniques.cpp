...
{
    // Read the image file
    Mat image = imread("E:\\OPENCVr\\opencv\\Task12\\picture.jpg");
    ...
    //Blur the image with 9x9 Gaussian kernel
    Mat image_blurred_with_9x9_kernel;
    GaussianBlur(image, image_blurred_with_9x9_kernel, Size(9, 9), 0);

    //Define names of the windows
    String window_name = "IMAGE";
    String window_name_blurred_with_3x3_kernel = " 3 x 3 Gaussian Kernel";
    String window_name_blurred_with_5x5_kernel = " 5 x 5 Gaussian Kernel";
    String window_name_blurred_with_9x9_kernel = " 9 x 9 Gaussian Kernel";
    ...
    imshow(window_name_blurred_with_9x9_kernel, image_blurred_with_5x5_kernel);
